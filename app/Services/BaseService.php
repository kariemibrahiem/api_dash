...
abstract class BaseService
{
    ...
    function getTimeDifferenceAsTime($startTime, $endTime)
    {
        ...
        $minutes = floor($diffInSeconds / 3600);
        $hours = floor(($diffInSeconds % 3600) / 60);

        return sprintf('%02d:%02d', $minutes , $hours);
    }
